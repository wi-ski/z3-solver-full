...
// include: /z3/src/api/js/src/low-level/async-wrapper.js
...
// end include: /z3/src/api/js/src/low-level/async-wrapper.js
...
var ASM_CONSTS = {
  21592520: () => { reject_async(new Error("Memory allocation failed")); },  
 21592577: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21592632: () => { reject_async(new Error("Memory allocation failed")); },  
 21592689: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21592744: () => { reject_async(new Error("Memory allocation failed")); },  
 21592801: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21592856: () => { reject_async(new Error("Memory allocation failed")); },  
 21592913: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21592968: () => { reject_async(new Error("Memory allocation failed")); },  
 21593025: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21593080: ($0) => { resolve_async($0); },  
 21593103: () => { reject_async(new Error('failed with unknown exception')); },  
 21593165: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21593212: () => { clearTimeout(threadTimeouts.shift()); },  
 21593254: ($0) => { resolve_async($0); },  
 21593277: () => { reject_async(new Error('failed with unknown exception')); },  
 21593339: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21593386: () => { clearTimeout(threadTimeouts.shift()); },  
 21593428: ($0) => { resolve_async($0); },  
 21593451: () => { reject_async(new Error('failed with unknown exception')); },  
 21593513: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21593560: () => { clearTimeout(threadTimeouts.shift()); },  
 21593602: ($0) => { resolve_async($0); },  
 21593625: () => { reject_async(new Error('failed with unknown exception')); },  
 21593687: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21593734: () => { clearTimeout(threadTimeouts.shift()); },  
 21593776: ($0) => { resolve_async($0); },  
 21593799: () => { reject_async(new Error('failed with unknown exception')); },  
 21593861: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21593908: () => { clearTimeout(threadTimeouts.shift()); },  
 21593950: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21594005: ($0) => { resolve_async(UTF8ToString($0)); },  
 21594042: () => { reject_async(new Error('failed with unknown exception')); },  
 21594104: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21594151: () => { clearTimeout(threadTimeouts.shift()); },  
 21594193: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21594248: ($0) => { resolve_async($0); },  
 21594271: () => { reject_async('failed with unknown exception'); },  
 21594322: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21594369: () => { clearTimeout(threadTimeouts.shift()); },  
 21594411: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21594466: ($0) => { resolve_async($0); },  
 21594489: () => { reject_async('failed with unknown exception'); },  
 21594540: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21594587: () => { clearTimeout(threadTimeouts.shift()); },  
 21594629: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21594684: ($0) => { resolve_async($0); },  
 21594707: () => { reject_async('failed with unknown exception'); },  
 21594758: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21594805: () => { clearTimeout(threadTimeouts.shift()); },  
 21594847: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21594902: ($0) => { resolve_async($0); },  
 21594925: () => { reject_async('failed with unknown exception'); },  
 21594976: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21595023: () => { clearTimeout(threadTimeouts.shift()); },  
 21595065: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21595120: ($0) => { resolve_async($0); },  
 21595143: () => { reject_async('failed with unknown exception'); },  
 21595194: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21595241: () => { clearTimeout(threadTimeouts.shift()); },  
 21595283: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21595338: ($0) => { resolve_async($0); },  
 21595361: () => { reject_async('failed with unknown exception'); },  
 21595412: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21595459: () => { clearTimeout(threadTimeouts.shift()); },  
 21595501: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21595556: ($0) => { resolve_async($0); },  
 21595579: () => { reject_async('failed with unknown exception'); },  
 21595630: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21595677: () => { clearTimeout(threadTimeouts.shift()); },  
 21595719: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21595774: ($0) => { resolve_async($0); },  
 21595797: () => { reject_async('failed with unknown exception'); },  
 21595848: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21595895: () => { clearTimeout(threadTimeouts.shift()); },  
 21595937: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21595992: ($0) => { resolve_async($0); },  
 21596015: () => { reject_async('failed with unknown exception'); },  
 21596066: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21596113: () => { clearTimeout(threadTimeouts.shift()); },  
 21596155: () => { threadTimeouts.push(setTimeout(() => {}, 600000)); },  
 21596210: ($0) => { resolve_async($0); },  
 21596233: () => { reject_async('failed with unknown exception'); },  
 21596284: ($0) => { reject_async(new Error(UTF8ToString($0))); },  
 21596331: () => { clearTimeout(threadTimeouts.shift()); }
};
...
var _Z3_set_error_handler = Module['_Z3_set_error_handler'] = createExportWrapper('Z3_set_error_handler', 2);
...
var _Z3_fixedpoint_set_reduce_assign_callback = Module['_Z3_fixedpoint_set_reduce_assign_callback'] = createExportWrapper('Z3_fixedpoint_set_reduce_assign_callback', 3);
var _Z3_fixedpoint_set_reduce_app_callback = Module['_Z3_fixedpoint_set_reduce_app_callback'] = createExportWrapper('Z3_fixedpoint_set_reduce_app_callback', 3);
var _Z3_fixedpoint_init = Module['_Z3_fixedpoint_init'] = createExportWrapper('Z3_fixedpoint_init', 3);
...
var _Z3_fixedpoint_add_callback = Module['_Z3_fixedpoint_add_callback'] = createExportWrapper('Z3_fixedpoint_add_callback', 6);
var _Z3_fixedpoint_add_constraint = Module['_Z3_fixedpoint_add_constraint'] = createExportWrapper('Z3_fixedpoint_add_constraint', 4);
...
var _Z3_optimize_register_model_eh = Module['_Z3_optimize_register_model_eh'] = createExportWrapper('Z3_optimize_register_model_eh', 5);
